About livy-submit-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/livy-submit-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8907&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/livy-submit-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `livy-submit` can be installed with `conda`:
...
```
mamba install livy-submit
```

It is possible to list all of the versions of `livy-submit` available on your platform with `conda`:
...
```
mamba search livy-submit --channel conda-forge
```
...
mamba repoquery search livy-submit --channel conda-forge

# List packages depending on `livy-submit`:
mamba repoquery whoneeds livy-submit --channel conda-forge

# List dependencies of `livy-submit`:
mamba repoquery depends livy-submit --channel conda-forge
```
